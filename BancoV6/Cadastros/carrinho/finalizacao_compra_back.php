<?php
    ...
    $sql = "INSERT INTO pic_venda (cod_venda, cod_usuario, datavenda, excluido) VALUES (DEFAULT, $codusuario, NOW(),'f');";
    $res = pg_query($conecta, $sql);
    ...
    { 
        ...
        $sql = "INSERT INTO pic_itemvenda (cod_venda, cod_produto, qtde, preco) VALUES (CURRVAL('venda_codvenda_seq'),".$codproduto.",".$qtde.",".$preco.");";
        $res = pg_query($conecta, $sql);
