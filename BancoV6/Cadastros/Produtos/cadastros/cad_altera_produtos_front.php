...
<body class="bodypn">
    ...
    ?>
    <div class="maepn">
        <h1 class="hua">Alteração de Produtos</h1>
        ...
        <form action="cad_altera_produtos_back.php" method="post">
            ...
            <br><br>
            <div class="btnus">
                <input class="btnfinalc" type="submit" value="Gravar">
                <input class="btnfinalfus" type="reset" value="Voltar" onclick="history.back()">
            </div>
        </form>
    </div>
</body>
